...
public class MainJavaSe {
	...
	private static void task05() {
		...
		EntityManager session = emf.createEntityManager();
		session.getTransaction().begin();
		Category cat2 = session.merge(category);
		cat2.setName("Electro");
		session.getTransaction().commit();
		session.close();
...
// TODO uncoment all the code below after you finish the TODO's
	...
	private static void task07() {
		...
		//TODO after you implement equals and hashCode, you can uncomment the code below. It will try
		// to check whether you are doing everything correctly. 
	
// TODO uncomment the following (it should work if you were successful with task08)
